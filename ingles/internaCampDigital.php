                    ...
                    <div class="col-lg-12">
                        <div class="project-thumbnail mb--30 text-center">
                            <div class="cars-image">
                                <img src="assets/images/case/project-detailsmarketing.jpg" alt="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="project-details-cont mt--30">
                                    <p>
                                        Your brand on social networks is not getting off the ground, do you think
                                        something is missing? Media Solution can offer you a solution. We manage your
                                        digital account in any social network. We go through the arts of postings,
                                        description, dissemination and other aspects that are sure to mark your digital
                                        presence.</p>
                                </div>
                            </div>
                        </div>
