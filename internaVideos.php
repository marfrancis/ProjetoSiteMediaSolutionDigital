                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="project-details-cont mt--30">
                                    <p>Tem um canal no YouTube, precisa de um vídeo para um trabalho, ou tem um projeto grande que envolve edição de vídeos? A Media Solution tem profissionais competentes e experientes na área que farão um excelente trabalho nos seus vídeos. Edição de vídeos de qualquer tamanho e conteúdo é com a Media Solution!</p>
                                </div>
                            </div>
                        </div>
                    </div>
