                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <div class="footer-info mt--60">
                                            ...
                                            <p>Ser reconhecida pelo mercado, clientes e colaboradores pela incessante
                                                busca da excelência em seus serviços e dedicação ao cliente.</p>
                                            <ul class="social">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <div class="footer-info  mt--60">
                                            ...
                                            <ul class="footer-list">
                                                ...
                                                <li><a href="#">Links Patrocinados - Google Adwords</a></li>
                                                <li><a href="#">SEO - Otimização de sites</a></li>
                                                <li><a href="#">Desenvolvimento de Web Site Responsivo e Site Mobile</a>
                                                </li>
                                    ...
                                    <div class="col-lg-3  col-md-6">
                                        ...
                                        <div class="footer-info  mt--60">
                                            ...
                                            <ul class="footer-list">
                                                <li>Avenida Paulista, 543 - São Paulo</li>
                                                <li><a href="#">contato@mediasolutionproducoes.com.br</a></li>
                                                <li><a href="#">37 99874-4814</a></li>
                                            </ul>
                                        </div>
                                        <!--// Footer-info End -->
                                    </div>
                                    <div class="col-lg-3  col-md-6">
                                        ...
                                        <div class="footer-info  mt--60">
                                            ...
                                            <ul class="footer-list-instagram">
                                                <li><a href="#"><img src="assets/images/instagram/ins-1.jpg" alt=""></a>
                                                </li>
                                                <li><a href="#"><img src="assets/images/instagram/ins-2.jpg" alt=""></a>
                                                </li>
                                                <li><a href="#"><img src="assets/images/instagram/ins-3.jpg" alt=""></a>
                                                </li>
                                                <li><a href="#"><img src="assets/images/instagram/ins-4.jpg" alt=""></a>
                                                </li>
                                                <li><a href="#"><img src="assets/images/instagram/ins-5.jpg" alt=""></a>
                                                </li>
                                                <li><a href="#"><img src="assets/images/instagram/ins-6.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!--// Footer-info End -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer-bottom-inner text-black text-center">
                                <p>Copyright &copy; Media Solution Digital 2019 Todos os Direitos Reservados</p>
                            </div>
                        </div>
                    </div>
                </div>
